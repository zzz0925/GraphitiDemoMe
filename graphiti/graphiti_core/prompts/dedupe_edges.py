...
def resolve_edge(context: dict[str, Any]) -> list[Message]:
    return [
        ...
        Task:
        If the NEW FACT represents the same factual information as any fact in EXISTING FACTS, return the ID of the duplicate fact as an integer in the field "duplicate_fact_id".
