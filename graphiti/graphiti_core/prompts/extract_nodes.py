...
def extract_message(context: dict[str, Any]) -> list[Message]:
    ...
    Your primary task is to extract and classify the speaker and other significant entities mentioned in the conversation.Please extract entities from the user's input and return them in the following JSON format:
...
5. **Formatting**:
   ...
   - return format such as " {
    "extracted_entities": [
        {"name": "zzz", "entity_type_id": 1},
        {"name": "西瓜", "entity_type_id": 2}
    ]
}"
...
def extract_json(context: dict[str, Any]) -> list[Message]:
    ...
    Your primary task is to extract and classify relevant entities from JSON files and return JSON"""
